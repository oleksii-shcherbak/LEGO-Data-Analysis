...
ADD CONSTRAINT FK_inventory_minifigures_inventories FOREIGN KEY (inventory_id) REFERENCES inventories(id);

-- Add foreign key constraint to inventory_minifigures referencing minifigures
ALTER TABLE inventory_minifigures
ADD CONSTRAINT FK_inventory_minifigures_minifigures FOREIGN KEY (fig_num) REFERENCES minifigures(fig_num);
...
ADD CONSTRAINT FK_part_relationships_child_parts FOREIGN KEY (child_part_num) REFERENCES parts(part_num);

-- Add foreign key constraint to part_relationships referencing parts for parent_part_num
ALTER TABLE part_relationships
ADD CONSTRAINT FK_part_relationships_parent_parts FOREIGN KEY (parent_part_num) REFERENCES parts(part_num);

-- Add foreign key constraint to parts referencing part_categories
ALTER TABLE parts
ADD CONSTRAINT FK_parts_part_categories FOREIGN KEY (part_cat_id) REFERENCES part_categories(id);
...
ALTER TABLE themes
ADD CONSTRAINT FK_themes_parent_themes FOREIGN KEY (parent_id) REFERENCES themes(id);
