...
ALTER TABLE 
	inventory_minifigures
ADD CONSTRAINT 
	FK_inventory_minifigures_inventories
FOREIGN KEY 
	(inventory_id)
REFERENCES 
	inventories(id);
...
ALTER TABLE 
	inventory_minifigures
ADD CONSTRAINT 
	FK_inventory_minifigures_minifigures
FOREIGN KEY 
	(fig_num)
REFERENCES 
	minifigures(fig_num);
...
ALTER TABLE 
	inventory_parts
ADD CONSTRAINT 
	FK_inventory_parts_inventories
FOREIGN KEY 
	(inventory_id)
REFERENCES 
	inventories(id);
...
ALTER TABLE 
	part_relationships
ADD CONSTRAINT 
	FK_part_relationships_child_parts
FOREIGN KEY 
	(child_part_num)
REFERENCES 
	parts(part_num);
...
ALTER TABLE 
	part_relationships
ADD CONSTRAINT 
	FK_part_relationships_parent_parts
FOREIGN KEY 
	(parent_part_num)
REFERENCES 
	parts(part_num);
